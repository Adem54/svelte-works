...
//Bu sayfayi random url ler uretmek icin kullanacagiz..twitter uygulamamizda
//Biz uygulamamizdaki database imize, data eklemek icin kullaniyoruz...yani tablolari olsturmustuk ama 
//icerisinde hic data yoktu biz 2 tane users datasi ve 8 tane twit datasi ekledik burda...
...
//Burdaki islemlerde , schema mizdaki ayni modeldir..user modeli ile yani
function getUsers() {
	return [
		{
			name: 'matia',
