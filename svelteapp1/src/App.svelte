...
3-Gonderilen props degerleri gonderildigi sayfa da script taglari icerisinde export ile alinir ve hangi key ile gonderildi ise o key ile alinarak kullanilir
